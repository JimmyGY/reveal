...
(function(){
	...
	var labelPos = {};
	var iconPos = {};
	var subTitleWidth = document.querySelector( ".reveal" ).offsetWidth * 0.3;
	var subTitleRegionProportion = 0.15;
	var subTitleRegionWidth = document.querySelector( ".reveal" ).offsetWidth * subTitleRegionProportion;
...
//console.debug( "Play " + currentAudio.id);
	...
	function setLocation(id,labelPos,iconPos,ifLabel){
				...
				if(!paging){
						...
						var labelStyleString = "position:absolute; to p: 20px; background-color : #C0C0C0 ; overflow-y: scroll ; max-height: 120px; left:"+labelPos.x+"px; top:"+labelPos.y+"px; width :" + subTitleWidth + "px;";
	...
	function subTitleLayout(labelElement,iconElement,labelTest){
		document.querySelector( ".reveal" ).setAttribute('style', "height:100%; left : 0px; width:" + (1 - subTitleRegionProportion) *100 +"%;");
		...
		if(subTitleRegion == null){
		    ...
		    subTitleRegion.setAttribute('style', "height:85%; font-size:30px ; border-left:1px dashed #000; border-bottom:1px dashed #000; position: fixed;  z-index: 10;bottom: 15%; left:" + (1 - subTitleRegionProportion) * 100 +"%;width:" + subTitleRegionProportion *100 +"%;");
		}
		subTitleRegion.style.display = "block";
		var labelStyleString = "position:fixed; background-color : #C0C0C0 ; overflow-y: scroll ; max-height: 120px; font-family: 'Times New Roman';";
		var iconStyleString = "position:fixed; width: 40 px;";;
	...
	function subTitlePosition(Px,Py,id){
		   ...
		   if(Px < 0 ){
			    ...
			    else if( Py + document.getElementById(iconId).offsetHeight >= document.querySelector( ".reveal" ).offsetHeight){
					labelPos.y = document.querySelector( ".reveal" ).offsetHeight - document.getElementById(labelId).offsetHeight;
					iconPos.y  = document.querySelector( ".reveal" ).offsetHeight - document.getElementById(iconId).offsetHeight;
				}
				else if(Py + document.getElementById(labelId).offsetHeight >= document.querySelector( ".reveal" ).offsetHeight){
					labelPos.y = document.querySelector( ".reveal" ).offsetHeight - document.getElementById(labelId).offsetHeight;
				}
			}
			else if(Px + document.getElementById(iconId).offsetWidth >= document.querySelector( ".reveal" ).offsetWidth * (1 - proportion) && !paging){
                subTitleLayout(document.getElementById(labelId),document.getElementById(iconId),labelTest);
				paging = true;
				return ; 
			}
			else if(Px + subTitleWidth >= document.querySelector( ".reveal" ).offsetWidth  * (1 - proportion) && !paging){
			    subTitleLayout(document.getElementById(labelId),document.getElementById(iconId),labelTest);
				paging = true;
				return ; 
			}
			else if(Px + subTitleRegionWidth >= document.querySelector( ".reveal" ).offsetWidth * (1 - proportion) && paging){
                subTitleLayout(document.getElementById(labelId),document.getElementById(iconId),labelTest);
				paging = true;
				return ; 
			}
	...
	function setupAudioElement( container, indices, audioFile, text, videoElement ,subtitle) {
	 ...
	 for(var i = 0;i < textArray.length; i++){
		...
		labelElement.setAttribute( 'style', "position:absolute; to p: 20px; background-color : #C0C0C0 ; left:30%; right: 20%;bottom: 10px;  overflow-y: scroll ; max-height: 120px; width :" + subTitleWidth + "px;" );
        ...
        icon.setAttribute('style', "position:absolute; to p: 20px; left:30%; width: 40px ; bottom: 10px;" );
