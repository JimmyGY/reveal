...
var RevealAce = window.RevealAce || (function() {
	...
	function mkEditor(iframe) {
		...
		d.write("<!DOCTYPE html><html>"+
			...
			"<script src='../reveal.js/plugin/reveal.js-ace/lib/ace.js' type='text/javascript' charset='utf-8'></script>")
		if (mode) {
			//d.write("<script src='https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.6/mode-" + mode + ".js' type='text/javascript' charset='utf-8'></script>");
			d.write("<script src='../reveal.js/plugin/reveal.js-ace/lib/mode-" + mode + ".js' type='text/javascript' charset='utf-8'></script>");
		}
		d.write("</head>"+
			"<body>"+
